...
HD_PWD='C:/Users/iremn/genel_fifo_arayuzu/genel_fifo_arayuzu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log genel_fifo_arayuzu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source genel_fifo_arayuzu.tcl
